...
/**
 * The type Element comparable atomic mass.
 */
public class Element_Comparable_AtomicMass extends Element {

    /**
     * Instantiates a new Element comparable atomic mass.
     *
     ...
     * @param atomicMass the atomic mass
     */
    public Element_Comparable_AtomicMass(float atomicMass){
        super(atomicMass);
    }
    ...
    public int compareTo(Element o) {
        return Float.compare(this.atomicMass,o.atomicMass);
    }
}
