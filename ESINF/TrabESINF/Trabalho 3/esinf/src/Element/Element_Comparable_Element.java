...
/**
 * The type Element comparable element.
 */
public class Element_Comparable_Element extends Element {

    /**
     * Instantiates a new Element comparable element.
     *
     ...
     * @param element the element
     */
    public Element_Comparable_Element(String element){
        super(element);
    }
    ...
    public int compareTo(Element o) {
        return this.element.compareToIgnoreCase(o.element);
    }
}
