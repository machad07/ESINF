...
/**
 * The type Element comparable symbol.
 */
public class Element_Comparable_Symbol extends Element {

    /**
     * Instantiates a new Element comparable symbol.
     *
     ...
     * @param symbol the symbol
     */
    public Element_Comparable_Symbol(String symbol){
        super(0,symbol);
    }
    ...
    public int compareTo(Element o) {
        return this.symbol.compareToIgnoreCase(o.symbol);
    }
}
