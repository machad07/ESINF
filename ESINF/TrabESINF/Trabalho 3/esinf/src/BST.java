...
// update methods
    ...
    private Node<E> remove(E element, Node<E> node) {
        ...
        if (node == null) {
            return null;    //throw new IllegalArgumentException("Element.Element does not exist");
        }
        if (element.compareTo(node.getElement())==0) {
    ...
    /**
     * Returns the Node containing a specific Element.Element, or null otherwise.
     *
     * @param node    the node
     * @param element the element to find
     * @return the Node that contains the Element.Element, or null otherwise This method despite not being essential is very useful. It is written here in order to be used by this class and its subclasses avoiding recoding. So its access level is protected
     */
